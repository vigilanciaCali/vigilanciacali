...
(function() {
  ...
  BBoxSelector = (function() {
    function BBoxSelector(image_frame, options) {
      ...
      console.log("1. function BBoxSelector");
    ...
    BBoxSelector.prototype.create_label_box = function(options) {
      ...
      console.log("1. function BBoxSelector.prototype.create_label_box");
    ...
    BBoxSelector.prototype.crop = function(pageX, pageY) {
      ...
      console.log("1. function BBoxSelector.prototype.crop");
      var point;
      return point = {
    ...
    BBoxSelector.prototype.start = function(pageX, pageY) {
      ...
      console.log("1. function BBoxSelector.prototype.start");
    ...
    BBoxSelector.prototype.finish = function(options) {
      ...
      console.log("1. function BBoxSelector.prototype.finish");
      var data;
      this.label_box.hide();
      this.selector.hide();
      data = this.rectangle();
  ...
  this.BBoxAnnotator = (function() {
    ...
    function BBoxAnnotator(options) {
      ...
      console.log("2. function BBoxAnnotator");
      ...
      //console.log("image_element.src: "+image_element.src);
    ...
    BBoxAnnotator.prototype.initialize_events = function(selector, options) {
      ...
      console.log("1. function BBoxSelector.prototype.initialize_events");
    ...
    BBoxAnnotator.prototype.clear_all = function(e) {
      ...
      console.log("1. function BBoxSelector.prototype.clear_all");
