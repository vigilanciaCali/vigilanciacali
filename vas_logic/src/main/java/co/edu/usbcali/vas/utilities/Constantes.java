...
public class Constantes
{
  ...
  public static String FTP_SERVER_USER = "FTP_SERVER_USER";
  ...
  public static String SERVICE_CONTROLLER = "SERVICE_CONTROLLER";
  ...
  public static String LOCAL_TEMP_VIDEO_FOLDER = "LOCAL_TEMP_VIDEO_FOLDER";
  //FORMAT
