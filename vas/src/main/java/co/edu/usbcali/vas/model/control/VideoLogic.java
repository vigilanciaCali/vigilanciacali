...
public class VideoLogic implements IVideoLogic {
    ...
    */
    ...
    public void saveVideo(Video entity) throws Exception {
        ...
        try {
            ...
            systemLogRestLogic.save_systemLogRest("VAS", "saveVideo ERROR: "+e);
            throw e;
        } finally {
        }
    }
    ...
    public List<VideoDTO> getDataVideo() throws Exception {
        try {
            List<Video> video = videoDAO.getVideoDataByIdASC();
            ...
            for (Video videoTmp : video) {
                ...
                videoDTO2.setTransferTime((videoTmp.getTransferTime() != null)
                        ? videoTmp.getTransferTime() : null);
                videoDTO2.setAnalysisTime((videoTmp.getAnalysisTime() != null)
                        ? videoTmp.getAnalysisTime() : null);
    ...
    public List<VideoDTO> getDataVideoTracker() throws Exception {
        try {
            List<Video> video = videoDAO.getVideoDataByTrackerById();
    ...
    public List<VideoDTO> getDataVideoAnomalous() throws Exception {
        try {
            List<Video> video = videoDAO.getVideoDataByAnomalousById();
            ...
            for (Video videoTmp : video) {
                ...
                videoDTO2.setUrl((videoTmp.getUrl() != null)
                    ? videoTmp.getUrl() : null);
                videoDTO2.setUrlPicture((videoTmp.getUrlPicture() != null)
                        ? videoTmp.getUrlPicture() : null);
                videoDTO2.setVideoData((videoTmp.getVideoData() != null)
                    ? videoTmp.getVideoData() : null);
                videoDTO2.setId_Users((videoTmp.getUsers().getId() != null)
                    ? videoTmp.getUsers().getId() : null);
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public void getAnlDataFromRest(String data) throws Exception {
        log.debug("getAnlDataFromRest Video instance");

        try {
            
        //FacesUtils.putinSession("anlFinalTime", data);
        	//log.info("User ID: "+FacesUtils.getfromSession(Constantes.SESSION_USER_ID));
    
        } catch (Exception e) {
            log.error("getAnlDataFromRest failed", e);
            throw e;
        } 
    }
}
