...
@ManagedBean
@ViewScoped
public class VideoAnalysisView2 implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(VideoAnalysisView2.class);
	...
	public String clear_data_anomalous() throws Exception {
		...
		try {
			...
			// update datatable
			this.action_refresh_anomalous();
			this.action_refresh_videoTempAnomalous();
