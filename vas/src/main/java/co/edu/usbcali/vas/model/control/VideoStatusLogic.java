...
public class VideoStatusLogic implements IVideoStatusLogic {
    ...
    */
    ...
    public void deleteVideoStatus(VideoStatus entity) throws Exception {
        ...
        List<VideoTemp> videoTemps = null;

        try {
            videoTemps = videoTempDAO.findByProperty("videoStatus.id",
                    entity.getId());

            if (Utilities.validationsList(videoTemps) == true) {
                throw new ZMessManager().new DeletingException("videoTemps");
            }
