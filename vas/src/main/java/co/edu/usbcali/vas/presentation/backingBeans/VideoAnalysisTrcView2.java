...
@ManagedBean
@ViewScoped
public class VideoAnalysisTrcView2 implements Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory.getLogger(VideoAnalysisTrcView2.class);
