...
public class NewsLogic implements INewsLogic {
    private static final Logger log = LoggerFactory.getLogger(NewsLogic.class);
    ...
    public List<News> getNews() throws Exception {
        ...
        try {
            ...
            log.error("finding all News failed", e);
    ...
    public void saveNews(News entity) throws Exception {
        ...
        try {
            ...
            if ((entity.getNewsInfo() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getNewsInfo(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException("newsInfo");
            }
    ...
    public void deleteNews(News entity) throws Exception {
        ...
        if (entity == null) {
            throw new ZMessManager().new NullEntityExcepcion("News");
        }
        ...
        try {
            ...
            log.debug("delete News successful");
        } catch (Exception e) {
    ...
    public void updateNews(News entity) throws Exception {
        log.debug("updating News instance");
        ...
        try {
            ...
            log.debug("update News successful");
        } catch (Exception e) {
    ...
    public List<NewsDTO> getDataNews() throws Exception {
        try {
            ...
            for (News newsTmp : news) {
                ...
                newsDTO2.setId(newsTmp.getId());
                newsDTO2.setCreatedAt(newsTmp.getCreatedAt());
                newsDTO2.setCreatedBy((newsTmp.getCreatedBy() != null)
                    ? newsTmp.getCreatedBy() : null);
                newsDTO2.setDescription((newsTmp.getDescription() != null)
                    ? newsTmp.getDescription() : null);
                newsDTO2.setMimeType((newsTmp.getMimeType() != null)
                    ? newsTmp.getMimeType() : null);
                newsDTO2.setNewsInfo((newsTmp.getNewsInfo() != null)
                    ? newsTmp.getNewsInfo() : null);
                newsDTO2.setSource((newsTmp.getSource() != null)
                    ? newsTmp.getSource() : null);
                newsDTO2.setSrc((newsTmp.getSrc() != null) ? newsTmp.getSrc()
                                                           : null);
                newsDTO2.setUpdatedAt(newsTmp.getUpdatedAt());
                newsDTO2.setUpdatedBy((newsTmp.getUpdatedBy() != null)
                    ? newsTmp.getUpdatedBy() : null);
                newsDTO2.setUrl((newsTmp.getUrl() != null) ? newsTmp.getUrl()
                                                           : null);
    ...
    public News getNews(Long id) throws Exception {
        log.debug("getting News instance");

        News entity = null;

        try {
            entity = newsDAO.findById(id);
        } catch (Exception e) {
            log.error("get News failed", e);
            throw new ZMessManager().new FindingException("News");
        } finally {
        }
    ...
    public List<News> findPageNews(String sortColumnName,
        ...
        try {
            entity = newsDAO.findPage(sortColumnName, sortAscending, startRow,
                    maxResults);
        } catch (Exception e) {
            throw new ZMessManager().new FindingException("News Count");
        } finally {
        }
    ...
    * de busqueda voy a hacer.., ejemplo: where nombre=william o where nombre<>william,
    ...
    public List<News> findByCriteria(Object[] variables,
        ...
        try {
            list = newsDAO.findByCriteria(where);
        } catch (Exception e) {
