...
function init() {
    ...
    console.log("1. media_properties.length "+media_properties.length);
    ...
    console.log("2. media_properties.duration "+media_properties.duration);
...
function init_properties(id, arrayPropDef, arrayProp) {
    ...
    do {
		...
		console.log("3. arrayProp[i] "+arrayPropDef[11]);
...
[
 [
	...
	"/home/gordon/Videos/video_demo_2.mp4",
	"/home/gordon/Videos/video_demo_2.mp4"
 ],
 [
