...
public class SystemLog  implements java.io.Serializable {
    ...
    public SystemLog(Long id, Date actionDate, String actionName) {
        this.id = id;
        this.actionDate = actionDate;
        this.actionName = actionName;
    }
    public SystemLog(Long id, Integer userId, String userName, Date actionDate, String actionName, String note, String ip) {
       this.id = id;
       this.userId = userId;
