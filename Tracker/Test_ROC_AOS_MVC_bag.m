function Test_ROC_AOS_MVC_bag(Distortion,v,Display,varargin)
...
tests_array = [2, 1, 5, 8, 5, 4, 4, 6, 1, 9, 8, 8, 7, 1, 8, 7, 1, 3, 9, 9, 2, 1, 5, 2];
...
%     v = videos_array(vid_index);
    ...
    %        'CellSize','BlockSize','BlockOverlap','Numbins','N_HOG');   
        ...
        % Generate cell arrayfor multi-instance learning
        bag = [{hogS(1:Nobj,:)}, {hogS(Nobj+1:Nobj+Nbg,:)}];
