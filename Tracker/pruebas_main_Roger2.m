function [] = pruebas_main_Roger2(v,distosion)
TotalTIme = tic
...
[ROC_PH,ROC_AH,AOSH] = Test_ROC_AOS_MVC_NSS_Prueba(distosion,v,HOG,Cs,Display,saveas, PC,Norm,1);
[ROC_PN,ROC_AN] = Test_ROC_AOS_MVC_NSS_Prueba(distosion,v,NSS1,Cs,Display,saveas, PC,Norm,0);

[ROC_PHN,ROC_AHN,AOSHN] = Test_ROC_AOS_MVC_NSS_Prueba(distosion,v,HOG,Cs,Display,saveas, PC,NormN,0);
disp('processing 4th feature set');
[ROC_PNN,ROC_ANN] = Test_ROC_AOS_MVC_NSS_Prueba(distosion,v,NSS1,Cs,Display,saveas, PC,NormN,0);
disp('processing 5th feature set');
[ROC_PHZ,ROC_AHZ,AOSHZ] = Test_ROC_AOS_MVC_NSS_Prueba(distosion,v,HOG,Cs,Display,saveas, PC,NormZ,0);
disp('processing 6th feature set');
[ROC_PNZ,ROC_ANZ] = Test_ROC_AOS_MVC_NSS_Prueba(distosion,v,NSS1,Cs,Display,saveas, PC,NormZ,0);
